...
def test_add_endpoint_access(api_key_analytics, user, active_only_api_key):
    endpoint = '/api/data'
    ApiKeyAnalytics.objects.add_endpoint_access(api_key_id=active_only_api_key.id, endpoint=endpoint)
...
def test_get_most_accessed_endpoints(api_key_analytics, user, active_only_api_key):
    ...
    most_accessed = ApiKeyAnalytics.objects.get_most_accessed_endpoints(api_key_id=active_only_api_key.id)
...
def test_str(api_key_analytics, user, active_only_api_key):
    assert str(api_key_analytics) == f'API Key {api_key_analytics.api_key.name} Analytics'
