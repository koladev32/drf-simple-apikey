...
class TestApiKeyAuthenticationWithIPManagement:
    ...
    def test_authenticate_valid_request_with_whitelisted_ip(self, valid_request_with_whitelisted_ip,
    ...
    def test_authenticate_denied_for_blacklisted_ip(self, valid_request_with_blacklisted_ip, api_key_authentication):
        """Tests that a request from a blacklisted IP is denied."""
        with pytest.raises(
                exceptions.AuthenticationFailed,
                match=r"Access denied from blacklisted IP."
        ):
            api_key_authentication.authenticate(valid_request_with_blacklisted_ip)

    def test_authenticate_denied_for_unlisted_ip_with_existing_whitelist(self, request_with_unlisted_ip,
                                                                         api_key_authentication):
    ...
    def test_authenticate_allowed_for_request_with_no_ip_restrictions(self, user, active_api_key,
                                                                      api_key_authentication):
